...
public class MsgPublisher {
    ...
    private static void publisherMain(int domainId, int sampleCount) {
        ...
        try {
            ...
            final long sendPeriodMillis = 250; // 4 seconds
            String[] words = {"Apple", "Spinach", "Carrots", "Lentil", "Banana", "Potato",     "Pear",
		        	"Avacado","Cherry","Orange"};

			for (int count = 0;
			(sampleCount == 0) || (count < sampleCount);
			++count) {
			    System.out.println("Writing " + words[count%10] + " #"+ count%10);
			
			    /* Modify the instance to be written here */
			    instance.message = words[count%10];
			    instance.sender = "Stacy Schauls";
			    instance.messageNumber = count%10;
