...
/**
* A sequence of Msg instances.
*/
public final class MsgSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public MsgSeq (int initialMaximum) {
        super(Msg.class, initialMaximum);
    }

    public MsgSeq (Collection elements) {
