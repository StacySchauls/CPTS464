        ...
        public void on_data_available(DataReader reader) {
            ...
            try {
                ...
                for(int i = 0; i < _dataSeq.size(); ++i) {
                    ...
                    if (info.valid_data) {
                    	System.out.println("Messaged Received  #"+((Msg)_dataSeq.get(i)).messageNumber + "\nSender: "+ ((Msg)_dataSeq.get(i)).sender.toString() + 
                    			"\nMessage:" + ((Msg)_dataSeq.get(i)).message.toString()+"\n");
                       // System.out.println(
