...
public class Passenger1 {
	...
	private static void subscriberMain(int domainId, int sampleCount) {
		...
		try {
			...
			// --- Wait for data --- //
			System.out.println("I am passenger 1. I am waiting for the bus...");
							...
							Position p = pdata.get(i);
								...
								if(onBus == false) {
									...
									if(p.vehicle.equalsIgnoreCase(myCurrentBus)){
										System.out.println(MessageFormat.format("Bus {0} Ariving at stop {1}. Time: {2}. Stops left: {3}", p.vehicle, p.stopNumber, p.timestamp, Math.abs(p.stopNumber - myTargetStop) % p.numStops));
									}
						...
						if (info.valid_data) {
							...
							Accident p = _dataSeq.get(i);
								...
								if(onBus == false) {
									...
									if(p.vehicle.equalsIgnoreCase(myCurrentBus)){
										System.out.println(MessageFormat.format("Bus {0} Ariving at stop {1}. Time: {2}. Stops left: {3}", p.vehicle, p.stopNumber, p.timestamp, 0));
									}
